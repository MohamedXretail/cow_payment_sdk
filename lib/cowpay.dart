        ...
        builder: (context, state) {
          return Container(
              ...
              child: Padding(
                  ...
                  child:
                      // (widget.showFawryOption ?? false)
                      //     ? _buildTabCard(1, 1, context)
                      //     : _buildTabCard(0, 0, context)
            ...
            decoration: BoxDecoration(
                border: Border.all(
                    ...
                    color: currentIndex == index
                        ? (widget.mainColor ?? Color.fromRGBO(24, 128, 64, 1))
                        : Colors.grey),
                boxShadow: [
                  new BoxShadow(
